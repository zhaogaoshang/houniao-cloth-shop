<template>
  <div class="public-column category">
    <user>
        <search @search="handleSearch" v-model="params.specialOptionName"></search>
        <discolor-btn typeStyle="middle" @click.native="handleIsShowParentSpecial('add')">添加特体</discolor-btn>
    </user>
